...
//	srand(time(NULL));
	...
	printf("\n	Trototipo:	declara la funcion y su tipo \n");
	printf("\n--------------------- Funcion Entrada --------------------------------------\n");
	int contador_x = 0;
	int contador_y = 0;
//	srand(time(NULL));
	...
	}de retorno, Se declaran los parametros de entrada. Termina en ;");
	printf("\n	");
	printf("\n--------------------- Funcion Entrada --------------------------------------\n");
	int contador_x = 0;
	int contador_y = 0;
...
//	srand(time(NULL));
	...
	printf("\n    void nombre_de_la_funcion (int variable, float *puntero)<------No lleva punto y coma");
	printf("\n    ^  {               El cuerpo de la funcion va ente llaves");
	printf("\n    |     printf(variable);");
	printf("\n    |     *puntero = Variable + 10;");
	printf("\n    --->  return;<------la funcion es void no regresa ningun dato");
	printf("\n      }");
}
